...
public class ComTrackMagex {
    ...
    public String getStatus(){
        ...
        LogUtils.i("接收到getstatus数据：" + backstr);
...
//        6	Initialization running
    ...
    public String motorrest(int hang,int lie)
    {
        ...
        LogUtils.i("接收到motorrest数据：" + backstr);
    ...
    public String moverobot(int level){
        String str = "H"+ "26" + level;
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"moverobot发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"moverobot发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        long nowTime = System.currentTimeMillis();
        long endWhile = nowTime + 30000;  // 最多等待30000毫秒=30秒
        while(nowTime < endWhile){
            SystemClock.sleep(100);
            if(rxByteArray == null){
                // 需要再次发送,继续循环
    ...
    public String getMotorAddress14(){
        String str = "H"+ "20" + "0" + "0500" + "0040";
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"getMotorAddress14发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"getMotorAddress14发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"getMotorAddress14没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"getMotorAddress14的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = backstr.substring(4,backstr.length()-3);
            backstr = backstr.substring(0,28) + "," +
                    backstr.substring(32,60) + "," +
                    backstr.substring(64,92) + "," +
                    backstr.substring(96,124);
        }
    ...
    public String getMotorAddress58(){
        String str = "H"+ "20" + "0" + "0540" + "0040";
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"getMotorAddress58发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"getMotorAddress58发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"getMotorAddress58 没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"getMotorAddress58的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = backstr.substring(4,backstr.length()-3);
    ...
    public String getMotorSteps14(){
        String str = "H"+ "20" + "0" + "0600" + "0040";
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"getMotorSteps14发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"getMotorSteps14发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"getMotorSteps14没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"getMotorSteps14的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = backstr.substring(4,backstr.length()-3);
    ...
    public String getMotorSteps58(){
        String str = "H"+ "20" + "0" + "0640" + "0040";
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"getMotorSteps58发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"getMotorSteps58发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"getMotorSteps58 没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"getMotorSteps58的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = backstr.substring(4,backstr.length()-3);
    ...
    public String setMotorAddress14(String setting){
        String str = "H"+ "30" + "0" + "0500" + "0040" + setting;
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"setMotorAddress14发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"setMotorAddress14发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"setMotorAddress14没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"setMotorAddress14的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = "ok";
    ...
    public String setMotorAddress58(String setting){
        String str = "H"+ "30" + "0" + "0540" + "0040" + setting;
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"setMotorAddress58发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"setMotorAddress58发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"setMotorAddress58没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"setMotorAddress58的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = "ok";
    ...
    public String setMotorSteps14(String setting){
        String str = "H"+ "30" + "0" + "0600" + "0040" + setting;
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"setMotorSteps14发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"setMotorSteps14发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"setMotorSteps14没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"setMotorSteps14的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = "ok";
    ...
    public String setMotorSteps58(String setting){
        String str = "H"+ "30" + "0" + "0640" + "0040" + setting;
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"setMotorSteps58发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"setMotorSteps58发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"setMotorSteps58没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"setMotorSteps58的返回值:"+backstr);
        if(backstr.startsWith("R200")){
            backstr = "error";
        } else {
            backstr = "ok";
    ...
    public String refreshEEPROM(){
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i(TAG,"refreshEEPROM发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i(TAG,"refreshEEPROM发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e(TAG,"refreshEEPROM没有收到返回值");
            return "";
        }
        ...
        Log.i(TAG,"refreshEEPROM的返回值:"+backstr);
        if(backstr.startsWith("R211")){
            backstr = "ok";
        } else {
            backstr = "error";
        }
     ...
     * @return 返回货道结构类型
     */
    public String[] vend_out_ind_buylist(int hang,int lie,int fen,String goodscode,String payway,String payinfo,int onetosix) {
        lie++;
        String liestr = "" + lie;
        if (lie == 10) liestr = "A";
        else if (lie == 11) liestr = "B";
        ...
        String str = "H" + "12" + "1" + hang + liestr +
                String.format("%02x", fen / 256).toUpperCase() + String.format("%02x", fen % 256).toUpperCase()
                + "1" + "000"+onetosix;
        int ck = 0;
        for (int i = 0; i < str.length(); i++) {
            ck += (int) charToByteAscii(str.charAt(i));
        ...
        while (nowMills < whileEndMills) {
            ...
            String errorcode = backstr.substring(64, 66);
            Log.i(TAG, formathms.format(SystemClock.currentThreadTimeMillis())
                    + ";receivered back:" + backstr + ";长度:" + backstr.length() + ";错误代码:" + backstr.substring(64, 66));
            ...
            String sensor = "Sensor off";
            if ((byte) (bms2 & 0x40) == (byte) 0x40) {
                sensor = "Sensor on";
            }
            String door = "Door closed";
            if ((byte) (bms1 & 0x04) == (byte) 0x04) {
            ...
            Log.i("ComTrackMagex", mode + " , " + sensor + " , " + door + " , " + machine);
            ...
            if ((byte) (bds & 0x80) == (byte) 0x80) {
                ds += "Product detected in with console photosensor,";
            }
            //0	Machine busy
            //1	Vending automa running
            //2	Delivery ok
            ...
            //5	Take the product message
            //6	Initialization running
            //7	Product detected in with console photosensor
            ...
            if ((byte) (bds & 0x04) == (byte) 0x04) {
                ...
                if (errorcode.equals("00")) {
                    if (ds.contains("Product detected in with console photosensor")) {
                        rtn = "DeliveryError{未知}";
                    } else {
                        rtn = "DeliveryError{红外未检测到货物}";
                    }
                } else {
                    rtn = "DeliveryError{硬件故障" + errorcode + "}";
                }
                // 出货完成了，那么退出
                break;
            } else {
                rtn = "DeliveryErrorOther{未知出货错误" + deliverystatus + "}";

                Log.e(TAG, "Delivery error other 、查询发送次数：" + whilecount + ";{未知出货错误" + deliverystatus + "}");
            }
        }
        return new String[]{rtn,""+hang+lie,""+fen,goodscode,payway,payinfo};
    }
    ...
    public String[] vend_out_ind(int hang,int lie,int fen,String goodscode,String payway,String payinfo)
    {
        ...
        boolean isSendOk = false;
        for(int i=1;i<=3;i++) {
            LogUtils.i("发送出货指令数据：" + orderstr +"、命令发送次数："  + i);
            ...
            LogUtils.i("接收到出货指令数据：" + backstr+"、命令发送次数："  + i);
        ...
        while (nowMills < whileEndMills) {
            ...
            LogUtils.i("发送查询指令数据：" + orderstr +"、命令发送次数："  + whilecount);
            ...
            Log.i(TAG, formathms.format(SystemClock.currentThreadTimeMillis())
                    + ";receivered back:" + backstr + ";长度:" + backstr.length()+";错误代码:"+backstr.substring(64,66));
            LogUtils.i("接收到查询指令数据：" + backstr+"("+backstr.substring(4,8)+")("+backstr.substring(12,14)+"),查询发送次数："  + whilecount);
