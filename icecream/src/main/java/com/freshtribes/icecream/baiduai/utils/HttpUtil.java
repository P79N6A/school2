...
import com.freshtribes.icecream.baiduai.model.RequestParams;
import com.freshtribes.icecream.baiduai.parser.AccessTokenParser;
    ...
    public <T> void post(String path, String key, RequestParams params,
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Log.i("icecream_httputil","httputil post 异常");
                e.printStackTrace();
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i("icecream_httputil", "百度返回onResponse json->" + responseString);
                // {"result":[{"uid":"1","scores":[97.786476135254],"group_id":"icecream","user_info":"15958008080"}],"result_num":1,"ext_info":{"faceliveness":"0.98921400308609"},"log_id":2891844584040316}
                final T result;
                try {
