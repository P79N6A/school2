...
public class ComTrackMagex {
   ...
   // private SendThread mSendThread;
    ...
    public void openSerialPort() {
       /* Log.d("zlc1",iBaudRate+";"+databits+";"+stopbits+";"+jiaoyanbits);
    ...
    public String getStatus(){
        ...
        try {
            if (os != null) {
               // mOutputStream.write(fa_cmd, 0, fa_cmd.length);
                os.write(fa_cmd, 0, fa_cmd.length);
                os.flush();
            }
        } catch (IOException e) {
      ...
      //  Log.i("ComTrackMagex",mode + " , "+door + " , "+machine);
        Log.d("ceshijqs",mode + " , "+door + " , "+machine);
//        0	Machine busy
...
//        6	Initialization running
    ...
    public String moverobot(int level){
        ...
        long nowTime = System.currentTimeMillis();
        long endWhile = nowTime + 3000;  // 最多等待30000毫秒=30秒
        while(nowTime < endWhile){
            SystemClock.sleep(100);
            if(rxByteArray == null){
                // 需要再次发送,继续循环
    ...
    public String refreshEEPROM(){
        ...
        String ckstr = String.format("%02x", ck).toUpperCase();
        String orderstr = str + ckstr + "*";
        Log.i("zlc","refreshEEPROM发送:"+orderstr);

        byte[] fa_cmd = orderstr.getBytes();
        Log.i("zlc","refreshEEPROM发送:"+bytesToHexString(fa_cmd,fa_cmd.length));
        ...
        if(rxByteArray == null){
            Log.e("zlc","refreshEEPROM没有收到返回值");
            return "";
        }
        ...
        Log.i("zlc","refreshEEPROM的返回值:"+backstr);
