...
public class PressTwoAdapter extends RecyclerView.Adapter<PressTwoAdapter.ViewHolder>{
    ...
    public PressTwoAdapter(Activity basicparameterActivity, List<PressBean> press) {
