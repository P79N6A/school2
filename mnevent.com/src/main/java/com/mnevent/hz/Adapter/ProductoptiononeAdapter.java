...
public class ProductoptiononeAdapter extends RecyclerView.Adapter<ProductoptiononeAdapter.ViewHolder> {
    ...
    public ProductoptiononeAdapter(Activity productoptionActivity, PreLibBean bean) {
